...
public class WalpaperChangeService extends Service implements Runnable {

    private int wallpaperId[] = {R.drawable.logodatabse, R.drawable.logonetworking};
    private int waktu;
    private int FLAG=0;
    private Thread t;
    ...
    public int onStartCommand(Intent intent, int flag, int startId)
    {
        ...
        t = new Thread(WalpaperChangeService.this);
        t.start();
